...
| MCP Security 证据卡 | ../sources/cards/mcp-security-best-practices.md | 检查授权、凭证、会话、本地服务和代理信任边界 |
| OWASP LLM Top 10 证据卡 | ../sources/cards/owasp-llm-top10.md | 将风险类别映射到上线门禁，避免把清单当作完整审计 |
...
- 最小样例包：[fixtures/enterprise-mcp-tool-operations/README.md](fixtures/enterprise-mcp-tool-operations/README.md)
