...
| OpenAI Evals 证据卡 | ../sources/cards/openai-evals.md | 明确数据集、grader、运行和结果的最小证据结构 |
| Case-aware RAG 证据卡 | ../sources/cards/case-aware-rag-evaluation.md | 防止平均分掩盖 workflow 与严重失败 |
| Nubank 客服 Agent 证据卡 | ../sources/cards/nubank-support-agents.md | 连接离线模拟、人工一致性和线上业务指标 |
